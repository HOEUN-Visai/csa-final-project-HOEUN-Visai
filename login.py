...
def main_acc():
    ...
    Button(text="REGISTER", height="2", width="15",
           fg="#D8BFD8", command=register).pack(padx=1, pady=5)
...
def register():
    ...
    passLabel = Label(register_screen, text="Password",
                      fg="black", bg="#D8BFD8")
    ...
    Button(register_screen, text="Register", width=10,
           height=1, fg="black", command=register_user).pack()
...
def login():
    ...
    password_login_entry = Entry(
        login_screen, textvariable=password_verify, show='*').pack()

    Label(login_screen, text="").pack()
    Button(login_screen, text="Login", width=10, fg="black",
...
def user_not_found():
    ...
    Label(user_not_found_screen, fg="red",
          text="User Not Found!").pack(pady=20)
